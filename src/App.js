  ...
  return(
    ...
    <Introduce 
      ...
      />
          ...
          <News 
            name={"4/17 給食制度開始"}         
            description={"4/17より朝活部の新たな取り組みとして、給食部が発足しました。曜日ごとに担当が分かれ、自分たちで食材調達から調理まで行うことで、圧倒的なコスパの給食を提供します。給食部創設の松井は「生協の学食が高いことに問題意識を持ち、この度給食部を発足させました。お財布にも優しく、栄養満点な給食作りを目指します。」と語りました。"}
